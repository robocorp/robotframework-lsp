...
After this step, it should be possible to open the `example_vscode` folder in VSCode and launch
`Extension: Example VSCode` to have a new instance of VSCode with the loaded extension.
...
- Create a tag (`git tag example-vscode-0.0.X`) and push it.