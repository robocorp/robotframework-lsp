...
def write_py_commands():
    commands_py_file = os.path.join(vscode_py_src_dir, "robocode_vscode", "commands.py")
...
def write_py_settings():
    settings_py_file = os.path.join(vscode_py_src_dir, "robocode_vscode", "settings.py")
