...
- Update version (`python -m dev set-version 0.23.2`).
...
- Create a tag (`git tag robotframework-lsp-0.23.2`) and push it.

- Send release msg. i.e.:

Hi @channel, `RobotFramework Language Server 0.23.2` is now available.
