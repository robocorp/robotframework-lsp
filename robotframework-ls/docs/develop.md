...
- Update version (`python -m dev set-version 0.31.0`).
...
- Create a tag (`git tag robotframework-lsp-0.31.0`) and push it.

- Send release msg. i.e.:

Hi @channel, `RobotFramework Language Server 0.31.0` is now available.
