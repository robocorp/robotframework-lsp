...
- Update version (`python -m dev set-version 0.47.2`).
...
- Create a tag (`git tag robotframework-lsp-0.47.2`) and push it.

- Send release msg. i.e.:

Hi @channel, `Robot Framework Language Server 0.47.2` is now available.
