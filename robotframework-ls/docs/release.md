...
- Update version (`python -m dev set-version 1.1.3`).
...
- Create a tag (`git tag robotframework-lsp-1.1.3`) and push it.

- Send release msg. i.e.:

Hi @channel,

I'm happy to announce the release of `Robot Framework Language Server 1.1.3`.
