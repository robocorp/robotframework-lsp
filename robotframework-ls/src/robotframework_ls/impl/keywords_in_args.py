...
KEYWORD_NAME_TO_KEYWORD_INDEX = {
    ...
    "runkeywordandexpecterror": 2,  # run_keyword_and_expect_error
    "runkeywordandignoreerror": 1,  # run_keyword_and_ignore_error
    "runkeywordandreturn": 1,  # run_keyword_and_return
    "runkeywordandreturnif": 2,  # run_keyword_and_return_if
