...
ROBOT_INTERNAL_RFINTERACTIVE_START = (
    "robot.internal.rfinteractive.start"  # Create Interactive Console
)
ROBOT_INTERNAL_RFINTERACTIVE_EVALUATE = (
    "robot.internal.rfinteractive.evaluate"  # Evaluate in Interactive Console
)
ROBOT_INTERNAL_RFINTERACTIVE_STOP = (
    "robot.internal.rfinteractive.stop"  # Stop Interactive Console
)
