...
def test_dependency_graph_caches_basic(workspace, debug_cache_deps):
...
def test_dependency_graph_invalidate_unresolved_with_vars(workspace):
    from robotframework_ls.impl.completion_context import CompletionContext
...
def test_dependency_graph_invalidate_unresolved_with_vars_2(workspace):
    from robotframework_ls.impl.completion_context import CompletionContext

    workspace.set_root("case_deps")
    robot_doc = workspace.get_doc("root4.robot")
