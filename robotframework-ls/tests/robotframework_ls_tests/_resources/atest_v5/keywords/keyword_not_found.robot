...
#!  ^^^^^^^^^^^^^^^^^^^^^^^^^ Undefined keyword: No Keyword With This Name.
...
#!  ^^^^^^^^^^^^^^^^^^^^^^^^ Undefined keyword: this name is NOT altered.
...
#!  ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ Undefined keyword: BuiltIn.No Keyword With This Name.
...
#!  ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ Undefined keyword: built in. ThisName is _not_ altered.
...
#!  ^^^^^^^^^^^^^^^^^^^^^^ Undefined keyword: NoSuchLib.No Operation.
