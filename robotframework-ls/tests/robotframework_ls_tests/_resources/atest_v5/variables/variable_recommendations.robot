...
#!           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ Undefined variable: dEnOKkgGlYBHwotU2bifJ56w487jD2NJxCrcM62g
...
Many Similar Variables
    ...
    Log    ${SIMILAR VAR}
#!           ^^^^^^^^^^^ Undefined variable: SIMILAR VAR
...
#!           ^^^^^^^^^^^^^^^^^^^^ Undefined environment variable: THISS_ENV_VAR_IS_SET
...
#!           ^^^^^^^^^^^^^^^^^^^^^^^^^^^ Undefined environment variable: THIS_ENV_VAR_DOES_NOT_EXIST
...
#!                                  ^^^^^^^^^^^ Undefined variable: nnormal_var
