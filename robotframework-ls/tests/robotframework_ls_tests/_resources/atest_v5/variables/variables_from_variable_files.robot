...
#!                ^^^^^^^^^^^^^^^^^^^^^ Unresolved variable import: pythonpath_varfile.py
Variables         pythonpath_varfile       imported     as module
#!                ^^^^^^^^^^^^^^^^^^ Unresolved variable import: pythonpath_varfile
Variables         package.submodule
#!                ^^^^^^^^^^^^^^^^^ Unresolved variable import: package.submodule
...
#!                       ^^^^^^^^^^^^^^^^ Undefined variable: PYTHONPATH VAR 1
    Should be Equal    ${PYTHONPATH ARGS 1}    imported by path
#!                       ^^^^^^^^^^^^^^^^^ Undefined variable: PYTHONPATH ARGS 1
