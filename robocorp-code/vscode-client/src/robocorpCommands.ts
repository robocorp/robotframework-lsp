...
export const ROBOCORP_SET_PYTHON_INTERPRETER = "robocorp.setPythonInterpreter";  // Set python.pythonPath configuration (used by the Python extension) based on robot.yaml
