...
export async function activate(context: ExtensionContext) {
    try {
        ...
        commands.registerCommand(roboCommands.ROBOCORP_EDIT_ROBOCORP_INSPECTOR_LOCATOR, () => inspector.openRobocorpInspector());
        ...
        commands.registerCommand(roboCommands.ROBOCORP_COPY_LOCATOR_TO_CLIPBOARD_INTERNAL, () => copySelectedToClipboard());
