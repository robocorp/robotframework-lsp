...
ROBOCORP_CLOUD_LOGIN = "robocorp.cloudLogin"  # Log in Robocorp Cloud
ROBOCORP_CLOUD_LOGIN_INTERNAL = "robocorp.cloudLogin.internal"  # Log in Robocorp Cloud (receives credentials)
...
ROBOCORP_SET_PYTHON_INTERPRETER = "robocorp.setPythonInterpreter"  # Set python.pythonPath configuration (used by the Python extension) based on robot.yaml
