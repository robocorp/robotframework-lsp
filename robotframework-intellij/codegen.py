...
public class {{ class_ }} implements Configurable {
    ...
    public boolean isModified() {
        {{ preferences_class }} settings = {{ preferences_class }}.getInstance({% if require_project %}project{% endif %});
        {% for preference in preferences %}
...
public class {{ class_ }} implements PersistentStateComponent<RobotState> {
    ...
    public static @Nullable {{ class_ }} getInstance({% if require_project %}Project project{% endif %}) {
        try {
