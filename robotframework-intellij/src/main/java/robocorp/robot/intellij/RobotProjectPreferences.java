...
class RobotProjectState {
    ...
    public String robotCodeLensEnable = "";
}
...
public class RobotProjectPreferences implements PersistentStateComponent<RobotState> {
    ...
    public static final String ROBOT_CODE_LENS_ENABLE = "robot.codeLens.enable";
    ...
    public RobotState getState() {
        ...
        robotState.robotCodeLensEnable = getRobotCodeLensEnable();
        return robotState;
    }
    ...
    public void loadState(@NotNull RobotState robotState) {
        ...
        setRobotCodeLensEnable(robotState.robotCodeLensEnable);
    }
    ...
    public JsonObject asJsonObject() {
        ...
        if(!robotCodeLensEnable.isEmpty()){
            
            try {
                jsonObject.add(ROBOT_CODE_LENS_ENABLE, new JsonPrimitive(Boolean.parseBoolean(robotCodeLensEnable)));
            } catch(Exception e) {
                LOG.error(e);
            }
        }
    ...
    private String robotCodeLensEnable = "";

    public @NotNull String getRobotCodeLensEnable() {
        return robotCodeLensEnable;
    }

    public @Nullable JsonPrimitive getRobotCodeLensEnableAsJson() {
        if(robotCodeLensEnable.isEmpty()){
            return null;
        }
        
        return new JsonPrimitive(Boolean.parseBoolean(robotCodeLensEnable));
    }

    public @NotNull String validateRobotCodeLensEnable(String robotCodeLensEnable) {
        if(robotCodeLensEnable.isEmpty()) {
            return "";
        }
        try {
            
            new JsonPrimitive(Boolean.parseBoolean(robotCodeLensEnable));
    ...
    public void setRobotCodeLensEnable(String s) {
        if (s == null) {
            s = "";
        }
        if (s.equals(robotCodeLensEnable)) {
            return;
        }
        String old = robotCodeLensEnable;
        robotCodeLensEnable = s;
        for (LanguageServerDefinition.IPreferencesListener listener : listeners) {
            try {
                listener.onChanged(ROBOT_CODE_LENS_ENABLE, old, s);
            } catch (CancelledException e) {
                // just ignore at this point
            }
        }
