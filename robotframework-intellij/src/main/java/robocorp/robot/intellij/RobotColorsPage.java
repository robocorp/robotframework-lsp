...
public class RobotColorsPage implements ColorSettingsPage {
    ...
    static {
        ATTRIBUTES = new AttributesDescriptor[]{
                ...
                new AttributesDescriptor("color.settings.parameter.name", RobotFrameworkSyntaxHighlightingFactory.PARAMETER_NAME),
                new AttributesDescriptor("color.settings.argument.value", RobotFrameworkSyntaxHighlightingFactory.ARGUMENT_VALUE),
